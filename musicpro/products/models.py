...
class Category(models.Model):
    ...
    type = models.ForeignKey(
        Type, on_delete=models.CASCADE, blank=False, null=False)
...
class Subcategory(models.Model):
    name = models.CharField('subcategory', max_length=50,
...
class Stock(models.Model):
    product = models.ForeignKey(
        Product, related_name='stocks', on_delete=models.CASCADE, blank=False, null=False)
